            ...
            <div className="container footer-container">
                <div className="row">
                    ...
                    <div className='col-lg-3 useful-pages-section d-none d-lg-block'>
                        <p className='sections-footer fw-bolder'>Paginas utiles</p >
                    ...
                    <div className='col-lg-3 col-md-5 col-8 contact-section'>
                        ...
                        <div className="container">
                            <div className="row contact-container rounded-3">
                                ...
                                <div className="col-2">
                                    <p className='contact-container-text contact-text fw-medium lh-1'>Email</p>
                                    <p className='contact-container-text direct-info-contact fw-bold lh-1'>artetopia@arte.com</p>
                                </div>
                            </div>
                        </div>
                        <div className="container">
                            <div className="row contact-container rounded-3">
                                ...
                                <div className="col-8">
                                    <p className='contact-container-text contact-text fw-medium lh-1'>Telefono</p>
                                    <p className='contact-container-text direct-info-contact fw-bold lh-1'>55-ARTETOPIA</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container more-info-container">
                    <div className="row d-flex justify-content-lg-center">
                        <div className="row col-lg-2 col-md-3 col-5 more-info-button rounded-2 ms-2 me-2 d-flex ">
                            <button type="button" className="btn btn-labeled btn-default more-info-text d-flex justify-content-center align-items-center fs-4 ps-0">
                            Artesanos
