...
const CardCraftsman = ({websiteName, profilePic, rate, categories}) => {
    ...
    return (
        <div className="content-craftsman-container d-flex justify-content-center py-3">
                    ...
                    <div className="row">
                        {categories.map(category => (
                            <div className='col d-flex justify-content-evenly justify-content-md-center' key={category}>
                                <button className='categories-button-container d-fill text-center rounded-2 my-3 px-2 mx-md-3 px-md-4'>{category}</button>
                            </div>
                        ))}
                    </div>
                </div>
