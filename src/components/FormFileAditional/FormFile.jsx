...
const FormFileA = ({fileType, onChange, multiple, controlId}) => {
    return (
        <Form.Group controlId={controlId || 'formFile' } className="form-file-container button_upload">
          <label className="card d-flex justify-content-center border-0 form-label" htmlFor={controlId || 'formFile' }>
          <div className="file-uploader-container d-flex flex-column justify-content-center align-items-center m-3">
